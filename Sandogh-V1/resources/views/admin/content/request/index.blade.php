...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12 active" aria-current="page"> درخواست ها </li>
    </ol>
</nav>
        ...
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2 ">
                ...
                <section  class="d-flex justify-content-start align-items-center gap-1 fasele">
                    <a href="{{ route('admin.content.request.create') }}" class="btn btn-info btn-sm">ایجاد درخواست ها </a>
                </section>
